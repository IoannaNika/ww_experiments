...
for ref_set in "Connecticut" "USA" "North_America" "Global"; do \
  ...
  bash ../../../experiment_specific_scripts/run_kallisto_ref_sets.sh $benchmark 0 $ref_dir 0.1 $ref_set VOC_sequence_BA.2 ../../../
  done
...
for ref_set in "Connecticut" "USA" "North_America" "Global"; do \
  ref_dir="../../../data/Sublineages_Experiment/reference_sets/$ref_set"
  bash ../../../experiment_specific_scripts/run_kallisto_ref_set_sub_lineages_exp.sh $benchmark 0 $ref_dir 0.1 $ref_set
  done
