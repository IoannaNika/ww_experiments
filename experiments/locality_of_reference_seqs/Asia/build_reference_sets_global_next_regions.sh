...
"Global_next_regions ../../../../data/Proximity_Experiments/HPC/Asia/reference_sets/Global_next_regions/metadata.tsv ../../../../data/Proximity_Experiments/HPC/Asia/reference_sets/Global_next_regions/sequences.fasta" ; do \
    #make tuples 
    set -- $reference_set 
