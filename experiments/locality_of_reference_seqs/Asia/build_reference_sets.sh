...
IFS=','
n_content=0.001
for reference_set in "Haryana,Haryana,state" "Rajasthan,Rajasthan,state" "West Bengal,West_Bengal,state" "India,India,country" "Asia,Asia,continent" "Global,Global,all"; do \
